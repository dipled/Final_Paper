...
\section{Metateoremas}
    ...
    \begin{proof}[Prova do Teorema~\ref{teo:deducao}] A prova será dividida em duas partes:\\
        ...
        \noindent1. Caso $\phi_{1} = \beta$ seja instância de substituição de um axioma, a seguinte dedução mostra $\Gamma \conhil \alpha \to \beta$:
        \begin{align*}
            & \text{1. } \beta \tag{Suposição}\\
            & \text{2. } \beta \to (\alpha \to \beta) \tag{Ax1}\\
