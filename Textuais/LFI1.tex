    ...
    \begin{proof}[Prova do Lema~\ref{lem:lindenbaum}]\setbool{@fleqn}{false}
        ...
        \begin{adjustwidth}{1cm}{}
            ...
            \begin{adjustwidth}{1cm}{}
                ...
                Vamos supor $\phi_i \in \Delta$ e $\phi_i \not \in \Gamma_i$. Temos, por (3), $\Gamma_{i - 1} \nconhil \phi$. Pela definição de $\Gamma_i$, temos $\Gamma_{i - 1}, \phi_i \conhil \phi$. Portanto, por (2) e pela monotonicidade da \lfium{} (Proposição~\ref{prop:tarski}), temos $\Gamma_k, \phi_i \conhil \phi$, para qualquer $k \geq i$. Então, por (3), $\phi \not \in \Gamma_k$ para qualquer $k > i$. Portanto, $\phi_i \not \in \Delta$, o que contradiz a nossa suposição inicial. Portanto, $\phi_i \in \Gamma_i$.

            \end{adjustwidth}

            \noindent(5) Para todo $\Delta' \subseteq \Delta$ finito temos que existe um $\Gamma_i$ na sequência com $\Delta' \subseteq \Gamma_i$.
