\chapter{LFI1}
\label{cap:LFI1}
\migs{Acho que um título melhor para o capitulo seria ``A Lógica de Inconsistência Formal LFI1''}
...
\begin{definicao}[Complexidade de fórmulas]
    \label{def:complex}
    Dada uma fórmula $\phi \in \pazocal{L}_{\Sigma}$, a complexidade $C(\phi)$ de de uma fórmula $\phi$ qualquer é definida recursivamente da seguinte forma: \migs{Foi falado na reunião mas vou colocar aqui pra lembrar: Explicar o pq de a complexidade do operador de consistência somar 2}
    \begin{align*}
