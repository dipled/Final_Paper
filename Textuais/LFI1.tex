...
\section{Metateoremas}\label{sec:metateoremas}
    ...
    \begin{proof}[Prova do Lema~\ref{lem:matval}]
        ...
        \noindent \textbf{\textsc{Passo}} Hipótese de indução (HI): A propriedade vale para toda fórmula $\phi$ tal que $C(\phi) = k$, com $k < n$.
    ...
    \begin{proof}[Prova do Corolário~\ref{cor:intro_ou_esq}]
        ...
        Então, pelo metateorema da dedução (MTD) (Teorema~\ref{teo:deducao}), temos $\Gamma \conhil \alpha \to \phi \text{ e }\Gamma \conhil \beta \to \phi$.
