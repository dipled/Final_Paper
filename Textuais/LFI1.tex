...
\end{teorema}
\begin{proof} A prova será dividida em duas partes:\\
    ($\Longleftarrow$) Supondo $\Gamma \conhil \alpha \to \beta$, então existe uma sequência de dedução $\phi_{1} \ldots \phi_{n}$ onde $\phi_{n} = \alpha \to \beta$.
\end{proof}
