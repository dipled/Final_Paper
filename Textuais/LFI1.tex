...
\begin{definicao}[Complexidade de fórmulas]
    ...
    \end{align*}
\end{definicao}
Note que, dada a dependência de $\circ \alpha$ em $\{\alpha, \neg \alpha\}$, a complexidade $C(\circ \alpha)$ é definida como $C(\alpha) + 2$. Ou seja, a complexidade de uma fórmula $\circ \alpha$ é estritamente maior que a complexidade de $\alpha$ e $\neg \alpha$.
...
\begin{notacao}
    Utiliza-se $\alpha \leftrightarrow \beta$ para denotar uma bi-implicação, como forma de abreviar a fórmula $(\alpha \rightarrow \beta) \land (\beta \rightarrow \alpha)$. Além disso, utiliza-se $\bullet \alpha$ para denotar a consistência de uma fórmula $\alpha$, de modo a abreviar $\neg \circ \alpha$.
\end{notacao}
