...
\section{Metateoremas}\label{sec:metateoremas}
    ...
    \subsection{Completude em relação às bivalorações}\label{sec:comp}
        ...
        \begin{proof}[Prova da Proposição~\ref{prop:tarski}]
            ...
            \end{itemize}
            \begin{adjustwidth}{1cm}{}
                \textbf{Prova do item (i)}. Vamos supor $\phi \in \Gamma$. Então, pela definição de $\conhil$, temos $\Gamma \conhil \phi$.
                % \begin{align*}
                %     1.~& \phi\tag{Premissa}
                % \end{align*}
        ...
        \begin{proposicao}\label{prop:finit}        
            A lógica $\lfium{} = \langle \ling, \conhil \rangle$ é finitária \textnormal{(Definição~\ref{def:padrao})}.
        \end{proposicao}
