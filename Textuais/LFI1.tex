...
\section{Metateoremas}\label{sec:metateoremas}
    ...
    \begin{proof}[Prova do Lema~\ref{lem:lindenbaum}]\setbool{@fleqn}{false}
        ...
        \begin{adjustwidth}{1cm}{}
            ...
            \begin{adjustwidth}{1cm}{}
                Seja $\psi$ uma fórmula qualquer com $\psi \not \in \Delta$. Então $\phi = \phi_i$ para algum $i \in \mathbb{N}$. Pela definição de $\Delta$, temos $\phi_i \not \in \Gamma_i$. Por construção de \migs{Aqui $\rightarrow$} $\phi_{i + 1}$ \migsalt{é pra ser $\phi_{i + 1}$ mesmo?}, temos $\Gamma_i, \phi_i \conhil \phi$. Portanto, pela monotonicidade da \lfium{}, temos $\Delta \conhil \phi$. Logo, $\Delta$ é maximal não-trivial em relação a $\phi$ em \lfium{}.
