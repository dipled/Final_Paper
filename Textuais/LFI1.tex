...
\section{Metateoremas}\label{sec:metateoremas}
    ...
    \begin{proof}[Prova do Lema~\ref{lem:lindenbaum}]\setbool{@fleqn}{false}
        Dada $\lfium{} = \langle \ling, \conhil \rangle$ e seja $\Gamma \cup \{\phi\} \subseteq \ling$ um conjunto de fórmulas com $\Gamma \nconhil \phi$. Arranje \migs{Como?}\helena{TAMBÉM NÃO SEI ;-;} as fórmulas de $\ling$ numa sequência $\pazocal{C} = \phi_1, \phi_2, \ldots, \phi_i, \ldots$ e defina $\Gamma_i$ recursivamente da seguinte forma:
        \begin{align*}
        ...
        \begin{adjustwidth}{1cm}{}
            ...
            \begin{adjustwidth}{1cm}{}
                Seja $\psi$ uma fórmula qualquer com $\psi \not \in \Delta$. Então $\phi = \phi_i$ para algum $i \in \mathbb{N}$. Pela definição de $\Delta$, temos $\phi_i \not \in \Gamma_i$. Por construção de $\phi_{i + 1}$, temos $\Gamma_i, \phi_i \conhil \phi$. Portanto, pela monotonicidade da \lfium{}, temos $\Delta \conhil \phi$. Logo, $\Delta$ é maximal não-trivial em relação a $\phi$ em \lfium{}.
    ...
    \begin{proof}[Prova do Lema~\ref{lem:valoracao}]
        ...
        \begin{provaporcasos}
            ...
            \casodeprova{$\psi = \alpha \land \beta$.}
            ...
            \casodeprova{$\psi = \alpha \lor \beta$.}

                \begin{adjustwidth}{1cm}{}
                    \noindent ($\Longrightarrow$) Vamos supor $v(\alpha \lor \beta) = 1$. Logo, $\alpha \lor \beta \in \Gamma$.

                    \noindent Supondo que não é o caso que $\alpha \in \Gamma$, nem $\beta \in \Gamma$, temos $\Gamma, \alpha \conhil \phi$ e $\Gamma, \beta \conhil \phi$. Logo, pelo Corolário~\ref{cor:prova_por_casos}, temos $\Gamma, \alpha \lor \beta \conhil \phi$. Logo, pela monotonicidade da \lfium{} (Proposição~\ref{def:tarski}), temos $\Gamma \conhil \phi$, o que é uma contradição. Portanto $\alpha \in \Gamma$ ou $\beta \in \Gamma$.
                    
                    \noindent Logo, temos $v(\alpha) = 1$ ou $v(\beta) = 1$.

                    \noindent ($\Longleftarrow$) Vamos supor $v(\alpha)$ ou $v(\beta)$. Logo, temos $\alpha \in \Gamma$ ou $\beta \in \Gamma$.
