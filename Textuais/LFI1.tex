                        ...
                        \subcasodeprova{$h(\phi) = 1$ sse $v(\phi) = 1$ e $v(\neg \phi) = 0$.}
                            ...
                            \begin{provaporsubsubcasos}
                                \subsubcasodeprova{$v(\alpha) = 0$.}
                                    ...
                                    Por (HI) temos $h(\alpha) = 0$. Então, pela matriz de $\circ$, temos $h(\phi) = h(\circ \alpha) = 1$.
                                
                                \subsubcasodeprova{$v(\neg \alpha) = 0$.} 

                                    Por $(vNeg)$ temos $v(\alpha) = 1$.

                                    Por (HI) temos $h(\alpha) = 1$. Então, pela matriz de $\circ$, temos $h(\phi) = h(\circ \alpha) = 1$.
                            \end{provaporsubsubcasos}
                            
                        \subcasodeprova{$h(\phi) = \meio{}$ sse $v(\phi) = 1$ e $v(\neg \phi) = 1$.}

                            ($\Longrightarrow$) Supondo $h(\phi) = h(\circ \alpha) = \meio{}$, vamos provar $v(\phi) = 1$ e $v(\neg \phi) = 1$.
