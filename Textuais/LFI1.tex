    ...
    \begin{proof}[Prova do Lema~\ref{lem:matval}]
        ...
        \begin{provaporcasos}
            ...
            \begin{provaporsubcasos}
                ...
                \begin{align*}
                    &\text{Teremos } h(\phi) = h(\alpha \land \beta) = h(\alpha) \land h(\beta) = 1\\
                ...
                \begin{align*}
                    &\text{Teremos } h(\phi) = h(\alpha \land \beta) = h(\alpha) \land h(\beta) = \meio{}\\
                ...
                \begin{align*}
                    &\text{Teremos } h(\phi) = h(\alpha \land \beta) = h(\alpha) \land h(\beta) = 0\\
