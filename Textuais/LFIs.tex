...
\begin{definicao}[Substituição]
    Uma substituição $\sigma$ de todas as ocorrências de uma variável $p$ por uma fórmula $\psi$ em uma fórmula $\phi$, é denotada por $\sigma(\phi) = \phi[p \mapsto \psi]$~\cite{dedo}. A substituição $\phi[p_{i} \mapsto \psi]$ é definida indutivamente como:
    \begin{align*}
        ...
        & \text{4.~Se }\phi = \phi_{0} \otimes \phi_{1} \text{ com } \otimes \in \{\land, \lor, \rightarrow\} \text{ entao, } \phi[p_{i} \mapsto \psi] = \phi_{0}[p_{i} \mapsto \psi] \otimes \phi_{1}[p_{i} \mapsto \psi].
    \end{align*}
\end{definicao}
