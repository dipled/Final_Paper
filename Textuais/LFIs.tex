...
\label{sec:paracons}
    ...
    \begin{notacao}
        Dada uma função $f$ e um subconjunto $A$ de seu domínio \migs{Eu achei que ``subconjunto $A$ de seu domínio'' ficou meio estranho, talvez poderia trocar por ``conjunto qualquer $A$ de fórmulas'' ou algo semelhante}, $f[A]$ \migscortar{resume}{ representa} o conjunto $\{f(a) \; | \; a \in A\}$.
    \end{notacao}
