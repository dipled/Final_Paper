...
\begin{definicao}[Lógica padrão]
    ...
    \end{align*}
    \helena{mandar email perguntando se é variável por fórmula e ele escreveu errado ou só ir na fé e alegria? BTW DEFINIR SUBSTITUIÇÕES E APRESENTAR ESSA NOTAÇÃO}
