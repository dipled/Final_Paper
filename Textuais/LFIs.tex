...
\begin{itemize}
    \item $p, q, r\ldots$ (letras minúsculas do alfabeto latino) {--} variáveis atômicas.
    \item $A, B, C, \ldots$ (letras maiúsculas do alfabeto latino) {--} conjuntos quaisquer.
