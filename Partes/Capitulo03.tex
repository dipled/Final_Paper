...
\section{Metateoremas}
    ...
    \begin{proof}[Prova do Teorema~\ref{teo:correcao}]
        ...
        \noindent 1.5. Caso $\phi_{1} = (\alpha \land \beta) \to \beta$. Suponha $v((\alpha \land \beta) \to \beta) = 0$. Logo $v(\alpha \land \beta) = 1$ e $v(\beta) = 0$ por $(vImp)$. Então, $v(\alpha) = 1$ e $v(\beta) = 1$ por $(vAnd)$, o que resulta numa contradição, portanto $v((\alpha \land \beta) \to \beta) = 1$.
    \end{proof}
