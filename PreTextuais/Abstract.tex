...
% possíveis no estudo destes sistemas. Ademais, assistentes de provas como o Rocq proporcionam
...
% como desenvolver metateoremas para este sistema no assistente de provas Rocq.
% resumo em inglês
