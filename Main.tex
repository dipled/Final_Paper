...
% -----------------------------------------------------------------
\titulo{Implementação de uma biblioteca da Lógica de Inconsistência Formal LFI1 em Rocq}%
...
\include{Textuais/LFIs}
\include{Textuais/LFI1}
\include{Textuais/Biblioteca}
\include{Textuais/ConclusãoParcial}
% \include{Textuais/Teste}
